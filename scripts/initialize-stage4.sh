...
echo "setting permissions for various portage-related directories"
chmod a+rx "${runtimeRoot}/usr/portage" "${runtimeRoot}/var/portage/"{,packages} "${runtimeRoot}/usr/local/portage" 
