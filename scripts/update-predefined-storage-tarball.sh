...
PHP_UPLOADS_UIDGID="81:81"
TMP_PERMS="2755"
DIRS="${DESTINATION_BASEDIR}/iso ${DESTINATION_BASEDIR}/iso-choosable ${DESTINATION_BASEDIR}/vm-dynamic ${DESTINATION_BASEDIR}/vm-persistent ${DESTINATION_BASEDIR}/vm-templates ${DESTINATION_BASEDIR}/tmp/apache-php-uploads"
...
chown ${PHP_UPLOADS_UIDGID} "${TEMPDIR}/${DESTINATION_BASEDIR}/tmp/apache-php-uploads"
chmod ${TMP_PERMS} "${TEMPDIR}/${DESTINATION_BASEDIR}/tmp"
